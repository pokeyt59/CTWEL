// Name: Colour DEgrade (Ultra Optimized)
// Description: Runtime dithering effects – maximum performance, compatible with Colour Lab V3.
// Optimizations: integer error diffusion, LUT caching, OffscreenCanvas, canvas pooling, etc.
// License: MIT
  ...
  async function applyDitherToTarget(runtime, target, ditherSpec) {
    ...
    switch (ditherSpec.type) {
      case "floyd-steinberg":
        processedImageData = floydSteinberg(imageData, {
        ...
        break;
      case "ordered":
        processedImageData = orderedDither(imageData, {
        ...
        break;
      case "threshold":
        processedImageData = thresholdDither(imageData, {
          levels: ditherSpec.levels,
          monochrome: ditherSpec.monochrome,
        });
        break;
