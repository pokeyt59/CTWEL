...
(function (Scratch) {
  ...
  // ============================================================
  // DITHERING ALGORITHMS (corrected & robust)
  // ============================================================
  ...
  function floydSteinberg(imageData, levels) {
    ...
    for (let y = 0; y < height; y++) {
      for (let x = 0; x < width; x++) {
        ...
        // Distribute errors to neighbours
        if (x + 1 < width) {
          const nIdx = idx + 4;
  ...
  // Ordered dither (Bayer) with configurable matrix size
  ...
  // Simple threshold dither (posterization)
